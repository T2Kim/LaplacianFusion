...
from lib.smplx.utils import save_params
...
# parser.add_argument("--target_subj", default='NeuroGIF_JacketPants_allall')
# parser.add_argument("--target_gender", default='male')
# parser.add_argument('--flathand', default=False)
# parser.add_argument("--useRGB", default=False)
...
# parser.add_argument("--target_subj", default='NeuroGIF_JacketShorts')
# parser.add_argument("--target_gender", default='male')
# parser.add_argument('--flathand', default=False)
# parser.add_argument("--useRGB", default=False)
...
def main(model, target_dir, device, dtype, use_RGBD = True, input_params=None):
    ...
    # priors["DVM_weight"] = 10000
    # priors["OP_weight"] = 0
    # priors["P2P_weight"] = 100
